...
namespace MusicTool.DataAccess.Services
{
    public class VnPayService : IVnPayService
    {
        ...
        public string CreatePaymentUrl(HttpContext context, VnPaymentRequestModel model)
        {
            ...
            var time = DateTime.Now.AddMinutes(318).ToString("yyyyMMddHHmmss");
            ...
            vnpay.AddRequestData("vnp_ExpireDate", time);
        ...
        public VnPaymentResponseModel PaymentExecute(IQueryCollection collections)
        {
            ...
            return new VnPaymentResponseModel
            {
                ...
                Amount = vnp_Amount,
                PayDate = DateTime.ParseExact(vnp_PayDate, "yyyyMMddHHmmss", CultureInfo.InvariantCulture)
            };
        }
    }
}
